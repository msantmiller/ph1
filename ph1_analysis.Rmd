...
interaction between the two measures. Each of these terms are found to be statistically
significant with 95 percent confidence. We visualize predictive relationships using
a three-dimensional plot, in which baseline antibody count is on the X-axis, baseline
antibody affinity is on the Y-axis, and the predicted mean of fold change is plotted
